 ...
 * 
 */
@WebServiceClient(name = "WSGestionUsuario", targetNamespace = "http://ws.udea.com/", wsdlLocation = "http://localhost:8080/WSUsuario/WSGestionUsuario?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSGESTIONUSUARIO_QNAME = new QName("http://ws.udea.com/", "WSGestionUsuario");
    ...
    public WSGestionUsuario getWSGestionUsuarioPort() {
        return super.getPort(new QName("http://ws.udea.com/", "WSGestionUsuarioPort"), WSGestionUsuario.class);
    }
    ...
    public WSGestionUsuario getWSGestionUsuarioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.udea.com/", "WSGestionUsuarioPort"), WSGestionUsuario.class, features);
    }
